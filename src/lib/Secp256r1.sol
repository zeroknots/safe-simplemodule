...
library Secp256r1 {
     ...
     */
    function Verify(PassKeyId memory passKey, uint256 r, uint256 s, uint256 e) internal returns (bool) {
        if (r >= nn || s >= nn) {
            return false;
        }
     ...
     */
    function scalarMultiplications(uint256 X, uint256 Y, uint256 u1, uint256 u2) internal returns (uint256, uint256) {
        uint256 x1;
        uint256 y1;
        uint256 z1;
     ...
     */
    function ShamirMultJacobian(uint256 X, uint256 Y, uint256 u1, uint256 u2, uint256 pqx, uint256 pqy, uint256 pqz)
        internal
        pure
     ...
     */
    function ScalarMult(uint256 Bx, uint256 By, uint256 k) internal returns (uint256, uint256) {
        uint256 x = 0;
        uint256 y = 0;
        uint256 z = 0;
    ...
    function ScalarMultJacobian(uint256 Bx, uint256 By, uint256 k) internal pure returns (uint256, uint256, uint256) {
        uint256 Bz = 1;
        uint256 x = 0;
        uint256 y = 0;
        uint256 z = 0;
    ...
    function ScalarBaseMultJacobian(uint256 k) internal pure returns (uint256, uint256, uint256) {
     ...
     */
    function _affineFromJacobian(uint256 x, uint256 y, uint256 z) internal returns (uint256 ax, uint256 ay) {
        if (z == 0) {
            return (0, 0);
        }
    ...
    function _primemod(uint256 value, uint256 p) internal returns (uint256 ret) {
    ...
    function modexp(uint256 _base, uint256 _exp, uint256 _mod) internal returns (uint256 ret) {
        assembly {
